# Historical maintainer notes (2026-09-19)

This is an archival reference, not active agent instructions. Current AGENTS.md and
the accepted product specifications supersede conflicting rules and dated facts.
See docs/product/specs/IMPLEMENTATION_INVENTORY.md for verified corrections.
