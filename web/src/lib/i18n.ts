...
export interface Strings {
  ...
  /** The achievements page. docs/spec/achievements/i18n.md. */
  readonly achievements: {
    ...
    readonly cell: (hero: string, scenario: string, attempts: number, wins: number) => string;
    readonly bestLevel: (level: string) => string;
    readonly filterHeroPack: string;
    ...
    readonly detailCompleted: string;
    readonly detailNeeded: string;
    readonly detailNoneCompleted: string;
    readonly detailAllCompleted: string;
    readonly detailRemaining: (count: number) => string;
    readonly detailCountAction: (what: 'plays' | 'wins' | 'heroes_played' | 'distinct_days', count: number) => string;
    readonly detailCountDone: (what: 'plays' | 'wins' | 'heroes_played' | 'distinct_days', count: number) => string;
    readonly detailWinAtLevel: (level: string) => string;
    readonly detailTableWin: (players: number) => string;
    readonly detailDistinctAspects: string;
    readonly detailCampaignWin: string;
    readonly detailNoDefeat: string;
    readonly detailCampaignLevel: (level: string) => string;
    readonly detailDraftWin: string;
    ...
    readonly toastMany: (count: number) => string;
    ...
    readonly tier: (tier: string) => string;
    readonly level: (level: string) => string;
  };
  /** Each achievement's words, by id; `{pack}` and `{n}` are filled by the page. */
  readonly achievement: Readonly<Record<string, { readonly title: string; readonly description: string }>>;
