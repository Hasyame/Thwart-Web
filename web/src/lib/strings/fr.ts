...
export const fr: Strings = {
  ...
  achievements: {
    ...
    pairsTitle: 'Duos héros et scénario battus',
    pairsOwned: (won, cells, heroes, scenarios) => `${won} sur les ${cells} possibles dans votre collection : ${heroes} héros × ${scenarios} scénarios.`,
    pairsGlobal: (won, cells, heroes, scenarios) => `${won} sur ${cells} dans tout le jeu (${heroes} héros × ${scenarios} scénarios).`,
    namedTitle: 'Succès nommés',
    namedCount: (unlocked, total) => `${unlocked} sur ${total} débloqués.`,
