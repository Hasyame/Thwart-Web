...
export const fr: Strings = {
  ...
  achievements: {
    ...
    pairsOwned: (won, cells, heroes, scenarios) => `${won} combinaisons héros-scénario gagnées sur les ${cells} possibles dans votre collection (${heroes} héros × ${scenarios} scénarios).`,
