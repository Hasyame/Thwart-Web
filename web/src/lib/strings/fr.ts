...
export const fr: Strings = {
  ...
  install: {
    ...
    button: 'Installer Thwart',
    installed: 'Thwart est installé sur cet appareil.',
    androidTitle: 'Android',
    androidOpen: 'Ouvrez thwart.app dans Chrome, Edge ou Samsung Internet.',
    androidMenu: 'Touchez Installer Thwart ci-dessus s’il apparaît. Sinon, ouvrez le menu ⋮ et choisissez Installer l’application (sur certains téléphones : Ajouter à l’écran d’accueil, puis Installer).',
    androidFirefox: 'Dans Firefox, ouvrez le menu ⋮ et choisissez Ajouter à l’écran d’accueil.',
  ...
  home: {
    ...
    lead:
      'Votre collection, vos decks, vos campagnes et vos parties de Marvel Champions, en français ou en anglais. Gratuit dans le navigateur ou installé sur votre téléphone comme une application.',
  ...
  achievements: {
    ...
    detailTiers: 'Paliers',
    detailCompleted: 'Accompli',
    detailNeeded: 'Reste à accomplir',
    detailNoneCompleted: 'Aucun objectif accompli pour le moment.',
    detailAllCompleted: 'Tous les objectifs sont accomplis.',
    detailRemaining: (count) => `Encore ${count} à accomplir`,
    detailCountAction: (what, count) => ({
      plays: `Enregistrez encore ${count} parties. Les victoires et les défaites comptent.`,
      wins: `Remportez encore ${count} victoires.`,
      heroes_played: `Jouez encore ${count} héros différents jamais enregistrés. Chaque place à la table compte, même lors d’une défaite.`,
      distinct_days: `Enregistrez des parties sur encore ${count} jours différents. Les jours sont comptés en UTC ; plusieurs parties le même jour comptent une seule fois.`,
    })[what] ?? '',
    detailCountDone: (what, count) => ({ plays: `${count} parties enregistrées.`, wins: `${count} victoires enregistrées.`, heroes_played: `${count} héros différents joués.`, distinct_days: `${count} jours différents joués (UTC).` })[what] ?? '',
    detailWinAtLevel: (level) => `Remportez une partie en difficulté ${level} ou supérieure.`,
    detailTableWin: (players) => `Remportez une partie enregistrée avec exactement ${players} joueurs.`,
    detailDistinctAspects: 'Chaque héros doit avoir une affinité et aucune affinité ne doit être partagée par deux héros à la table.',
    detailCampaignWin: 'Terminez une campagne avec succès. Une campagne déclarée perdue ne compte pas.',
    detailNoDefeat: 'La campagne terminée ne doit contenir aucune défaite enregistrée.',
    detailCampaignLevel: (level) => `La campagne elle-même doit être en difficulté ${level} ou supérieure.`,
    detailDraftWin: 'Remportez une partie avec un deck sauvegardé depuis le draft à la première place de héros. La partie enregistrée doit porter le mode Draft ; une défaite ou la simple fin d’un draft ne compte pas.',
    detailUnlockPlay: 'La partie qui l’a débloqué',
    detailDerived: 'Calculé à partir de votre historique. Chaque héros à la table compte.',
    detailFilters: 'Ces résultats suivent les filtres d’affinité et de difficulté sélectionnés sur la page.',
    detailFirstWin: (date) => `Première victoire : ${date}`,
    detailLastPlay: (date) => `Dernière partie : ${date}`,
  ...
  achievement: {
    ...
    draft_win: { title: "Novice du draft", description: "Gagnez 1 partie avec un deck construit en draft." },
    draft_wins_5: { title: "Adepte du draft", description: "Gagnez 5 parties avec un deck construit en draft." },
    draft_wins_10: { title: "Vétéran du draft", description: "Gagnez 10 parties avec un deck construit en draft." },
    draft_wins_50: { title: "Légende du draft", description: "Gagnez 50 parties avec un deck construit en draft." },
    sealed_win: { title: "Novice du scellé", description: "Gagnez 1 partie avec un deck construit en scellé." },
    sealed_wins_5: { title: "Adepte du scellé", description: "Gagnez 5 parties avec un deck construit en scellé." },
    sealed_wins_10: { title: "Vétéran du scellé", description: "Gagnez 10 parties avec un deck construit en scellé." },
    sealed_wins_50: { title: "Légende du scellé", description: "Gagnez 50 parties avec un deck construit en scellé." },
    losses_1: { title: "On se relève", description: "Terminez 1 partie sur une défaite. Chaque tentative fait partie de votre parcours héroïque." },
    losses_5: { title: "Toujours partant", description: "Terminez 5 parties sur une défaite. Chaque tentative fait partie de votre parcours héroïque." },
    losses_10: { title: "Cœur de héros", description: "Terminez 10 parties sur une défaite. Chaque tentative fait partie de votre parcours héroïque." },
    losses_50: { title: "Inébranlable", description: "Terminez 50 parties sur une défaite. Chaque tentative fait partie de votre parcours héroïque." },
    losses_100: { title: "Je peux faire ça toute la journée", description: "Terminez 100 parties sur une défaite. Chaque tentative fait partie de votre parcours héroïque." },
  },
  ...
  draft: {
    preparationFailed: 'Cette configuration ne peut pas être préparée avec la collection disponible. Vérifiez votre collection et les scénarios exclus, puis réessayez.',
    activeGame: 'Terminez ou sauvegardez la partie en cours avant d’en préparer une autre.',
    ...
    noUnplayed: 'Aucune nouvelle combinaison disponible avec ces filtres et choix verrouillés. Modifiez les filtres ou déverrouillez un choix.',
    sealed: 'Scellé',
    sealedAbandon: 'Abandonner le scellé',
    sealedAbandonConfirm: 'Abandonner ce scellé ? Vos choix seront perdus.',
    sealedStart: 'Lancer le scellé',
    sealedFinish: 'Enregistrer les decks scellés',
    reviseSealed: 'Modifier les cartes choisies',
    openBooster: (number) => `Ouvrir le booster ${number} sur 6`,
    boosterProgress: (number) => `Booster ${number} sur 6 · 10 cartes`,
    buildSealed: 'Construire mon deck avec les 60 cartes',
  ...
  campaignReadyDetail: 'Cartes en place : le scénario et son chrono démarrent.',
  campaignScenarioOver: 'Scénario terminé ?',
  campaignRecordResult: 'Notez comment il s’est terminé ; la campagne reprend de là.',
  ...
  campaignUpdated: (when) => `Mis à jour ${when}`,
  campaignScenariosTitle: 'Scénarios',
  campaignScenarioN: (n) => `Scénario ${n}`,
  ...
  campaignShowAll: (hidden) => `Afficher aussi ${hidden === 1 ? 'la campagne' : `les ${hidden} campagnes`} hors de ma collection`,
  campaignNotOwned: 'hors collection',
  campaignNoneOwned: 'Aucune boîte de campagne dans votre collection. Cochez vos boîtes sur la page Collection, ou affichez toutes les campagnes ci-dessous.',
  ...
  campaignSettingsTitle: 'Paramètres',
