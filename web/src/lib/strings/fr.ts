...
export const fr: Strings = {
  ...
  achievement: {
    beat_every_scenario_core: { title: 'Boîte de base nettoyée', description: 'Battez chaque scénario de {pack}.' },
    beat_every_scenario_trors: { title: 'Crâne Rouge nettoyé', description: 'Battez chaque scénario de {pack}.' },
    beat_every_scenario_gmw: { title: 'Galaxie nettoyée', description: 'Battez chaque scénario de {pack}.' },
    beat_every_scenario_mts: { title: 'Titan nettoyé', description: 'Battez chaque scénario de {pack}.' },
    beat_every_scenario_sm: { title: 'Sinistres nettoyés', description: 'Battez chaque scénario de {pack}.' },
    beat_every_scenario_mut_gen: { title: 'Genèse nettoyée', description: 'Battez chaque scénario de {pack}.' },
    beat_every_scenario_next_evol: { title: 'Évolution nettoyée', description: 'Battez chaque scénario de {pack}.' },
    beat_every_scenario_aoa: { title: 'Apocalypse nettoyée', description: 'Battez chaque scénario de {pack}.' },
    beat_every_scenario_aos: { title: 'S.H.I.E.L.D. nettoyé', description: 'Battez chaque scénario de {pack}.' },
    beat_every_scenario_fne: { title: 'La ville du Caïd nettoyée', description: 'Battez chaque scénario de {pack}.' },
