...
export const en: Strings = {
  ...
  achievements: {
    ...
    pairsOwned: (won, cells, heroes, scenarios) => `${won} hero–scenario combinations won of the ${cells} possible in your collection (${heroes} heroes × ${scenarios} scenarios).`,
    pairsGlobal: (won, cells, heroes, scenarios) => `${won} of ${cells} in the whole game (${heroes} heroes × ${scenarios} scenarios).`,
    namedTitle: 'Achievements',
    namedCount: (unlocked, total) => `${unlocked} of ${total} unlocked.`,
