...
export const en: Strings = {
  ...
  achievements: {
    ...
    pairsTitle: 'Hero and scenario pairings beaten',
    pairsOwned: (won, cells, heroes, scenarios) => `${won} of the ${cells} possible in your collection: ${heroes} heroes × ${scenarios} scenarios.`,
    pairsGlobal: (won, cells, heroes, scenarios) => `${won} of ${cells} in the whole game (${heroes} heroes × ${scenarios} scenarios).`,
    namedTitle: 'Named achievements',
