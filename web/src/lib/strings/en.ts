...
export const en: Strings = {
  ...
  achievements: {
    ...
    detailNeeded: 'Still needed',
    detailNoneCompleted: 'No requirements completed yet.',
    detailAllCompleted: 'All requirements completed.',
    detailRemaining: (count) => `${count} more needed`,
    detailCountAction: (what, count) => ({
      plays: `Record ${count} more games. Wins and losses both count.`,
      wins: `Win ${count} more games.`,
      heroes_played: `Play ${count} more different heroes you have not recorded yet. Every seat counts, including in a loss.`,
      distinct_days: `Record games on ${count} more different days. Days are counted in UTC; several games on the same day count once.`,
    })[what] ?? '',
    detailCountDone: (what, count) => ({ plays: `${count} games recorded.`, wins: `${count} victories recorded.`, heroes_played: `${count} different heroes played.`, distinct_days: `${count} different days played (UTC).` })[what] ?? '',
    detailWinAtLevel: (level) => `Win a game on ${level} difficulty or higher.`,
    detailTableWin: (players) => `Win a game recorded with exactly ${players} players.`,
    detailDistinctAspects: 'Every hero must have an aspect, and no aspect may be shared by two heroes at the table.',
    detailCampaignWin: 'Finish a campaign successfully. A campaign marked as lost does not count.',
    detailNoDefeat: 'The completed campaign must contain no recorded defeats.',
    detailCampaignLevel: (level) => `The campaign itself must be set to ${level} difficulty or higher.`,
    detailDraftWin: 'Win one game using a deck saved from the draft in the first hero slot. The recorded game must carry Draft mode; a loss or simply finishing a draft does not count.',
  ...
  achievement: {
    ...
    draft_win: { title: "Young Drafter", description: "Win 1 game with a deck built in draft." },
    draft_wins_5: { title: "Confirmed Drafter", description: "Win 5 games with a deck built in draft." },
    draft_wins_10: { title: "Experienced Drafter", description: "Win 10 games with a deck built in draft." },
    draft_wins_50: { title: "Legendary Drafter", description: "Win 50 games with a deck built in draft." },
    sealed_win: { title: "Young Sealed Player", description: "Win 1 game with a deck built in sealed." },
    sealed_wins_5: { title: "Confirmed Sealed Player", description: "Win 5 games with a deck built in sealed." },
    sealed_wins_10: { title: "Experienced Sealed Player", description: "Win 10 games with a deck built in sealed." },
    sealed_wins_50: { title: "Legendary Sealed Player", description: "Win 50 games with a deck built in sealed." },
    losses_1: { title: "Back on Your Feet", description: "Finish 1 game in defeat. Every attempt is part of your heroic journey." },
    losses_5: { title: "Ready for Another Round", description: "Finish 5 games in defeat. Every attempt is part of your heroic journey." },
    losses_10: { title: "Heart of a Hero", description: "Finish 10 games in defeat. Every attempt is part of your heroic journey." },
    losses_50: { title: "Unbreakable Spirit", description: "Finish 50 games in defeat. Every attempt is part of your heroic journey." },
    losses_100: { title: "I Can Do This All Day", description: "Finish 100 games in defeat. Every attempt is part of your heroic journey." },
  },
  ...
  draft: {
    preparationFailed: 'This setup cannot be prepared with the available collection. Check your collection and scenario exclusions, then try again.',
    activeGame: 'Finish or save the game already in progress before preparing another one.',
    ...
    noUnplayed: 'No new pairing is available with these filters and locked choices. Change the filters or unlock a choice.',
    sealed: 'Sealed',
    sealedAbandon: 'Abandon the sealed game',
    sealedAbandonConfirm: 'Abandon this sealed game? Your selections will be lost.',
    sealedStart: 'Deal the sealed pool',
    sealedFinish: 'Save the sealed decks',
    reviseSealed: 'Change selected cards',
    openBooster: (number) => `Open booster ${number} of 6`,
    boosterProgress: (number) => `Booster ${number} of 6 · 10 cards`,
    buildSealed: 'Build my deck from the 60 cards',
    ...
    sessionAdjust: 'Adjust the packs',
  ...
  campaignReadyDetail: 'Cards on the table: the scenario and its clock start.',
  campaignScenarioOver: 'Scenario over?',
  campaignRecordResult: 'Record how it ended; the campaign carries on from there.',
  ...
  campaignUpdated: (when) => `Updated ${when}`,
  campaignScenariosTitle: 'Scenarios',
  campaignScenarioN: (n) => `Scenario ${n}`,
  ...
  campaignBeatenBurst: 'Beaten!',
  campaignNoDeck: 'Deck not on this device',
  campaignShowAll: (hidden) => `Also show the ${hidden} campaign${hidden === 1 ? '' : 's'} not in my collection`,
  campaignNotOwned: 'not in your collection',
  campaignNoneOwned: 'No campaign box is in your collection. Tick your boxes on the Collection page, or show every campaign below.',
  ...
  campaignSettingsTitle: 'Settings',
